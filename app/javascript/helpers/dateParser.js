...
// A.) single date object, "April 7, 2023" => "Fri Apr 07 2023 00:00:00 GMT-0700 (Pacific Daylight Time)"
// B.) two date objects:
//     1.) "Apr 2 – 8, 2023"	=> 
...
export class DateParser {
    ...
    static determineDateTypeAndDelegate(dateString){
		...
		static handleWeekString(dateString) {
			...
			let endDateMonth, endDateDay, endDateYear, startDateMonth, startDateDay, startDateYear;
