...
ActiveRecord::Schema[7.0].define(version: 20_221_208_054_608) do
  ...
  create_table 'attribute_answers', force: :cascade do |t|
    ...
    t.index %w[employee_id employee_attribute_id], name: 'index_attribute_answers_on_employee_and_attribute',
                                                   unique: true
  ...
  create_table 'customers', force: :cascade do |t|
    ...
    t.index %w[email account_id], name: 'index_customers_on_email_and_account_id', unique: true
  end
  ...
  create_table 'employee_jobs', force: :cascade do |t|
    ...
    t.index %w[job_id employee_id], name: 'index_employee_jobs_on_job_id_and_employee_id', unique: true
  ...
  create_table 'employee_templates', force: :cascade do |t|
    ...
    t.index %w[title account_id], name: 'index_employee_templates_on_title_and_account_id', unique: true
  end
  ...
  create_table 'job_attribute_answers', force: :cascade do |t|
    ...
    t.index %w[job_id job_attribute_id], name: 'index_job_attribute_answers_on_job_and_attribute', unique: true
  ...
  create_table 'job_templates', force: :cascade do |t|
    ...
    t.index %w[title account_id], name: 'index_job_templates_on_title_and_account_id', unique: true
  end
  ...
  create_table 'resource_schedules', id: false, force: :cascade do |t|
    ...
    t.date 'job_date'
    t.index %w[company_resource_id job_id job_date], name: 'company_resource_job_schedule', unique: true
    t.index %w[company_resource_id job_id], name: 'index_resource_schedules_on_company_resource_id_and_job_id'
    t.index %w[job_id company_resource_id], name: 'index_resource_schedules_on_job_id_and_company_resource_id'
  end
