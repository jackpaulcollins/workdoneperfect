...
class EmployeeTemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create employee_template' do
    assert_difference('EmployeeTemplate.count') do
      post employee_templates_url,
           params: { employee_template: { account_id: @employee_template.account_id, title: 'Unique Title' } }
    end
  ...
  test 'should update employee_template' do
    patch employee_template_url(@employee_template),
          params: { employee_template: { account_id: @employee_template.account_id, title: @employee_template.title } }
