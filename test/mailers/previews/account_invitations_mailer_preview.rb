...
class AccountInvitationsMailerPreview < ActionMailer::Preview
  ...
  def invite
    ...
    account_invitation = AccountInvitation.new(id: 1, token: "fake", account:, name: "Test User",
      email: "test@example.com", invited_by: User.first)
    AccountInvitationsMailer.with(account_invitation:).invite
  end
end
