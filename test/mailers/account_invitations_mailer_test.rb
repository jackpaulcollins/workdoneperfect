...
class AccountInvitationsMailerTest < ActionMailer::TestCase
  test 'invite' do
    ...
    mail = AccountInvitationsMailer.with(account_invitation:).invite
    assert_equal I18n.t('account_invitations_mailer.invite.subject', inviter: 'User One', account: 'Company'),
                 mail.subject
